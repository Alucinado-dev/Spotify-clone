...
- **Exemplos de Temas**
  ### Tema padrão similar ao Spotify
  ![tema padrão spotify](src/assets/screenshots/spotify-clone2.png)

  ### Tema personalizado criado por mim
  ![tema personalizado 1](src/assets/screenshots/spotify-clone1.png)
...
Nome : Lucino De Campos
Github : [ALucin4do](https://github.com/ALucin4do)
LinkedIn : [Lucino De Campos](https://www.linkedin.com/in/lucino-de-campos-617527170)